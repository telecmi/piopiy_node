...
var PiopiyAction = function () {
    ...
    _createClass(PiopiyAction, [{
        key: 'playMusic',
        value: function playMusic(file_name) {
        ...
        value: function speak(text) {
            ...
            if (_index2.default.isString(text)) {
        ...
        key: 'playGetInput',
        value: function playGetInput(answer_url, file_name, option) {

            var input = _input2.default.play_input(answer_url, file_name, option);
