...
var _play_stream = require('./play_stream');
...
var StreamAction = function () {
    ...
    _createClass(StreamAction, [{
        ...
        key: 'playStream',
        value: function playStream(audio_base64, audio_type, sample_rate) {
            var play_stream = (0, _play_stream.playBase64Audio)(audio_base64, audio_type, sample_rate);
            return play_stream;
        }
    }, {
        key: 'PCMO',
